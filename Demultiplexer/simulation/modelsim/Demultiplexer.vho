...
-- s[1]	=>  Location: PIN_24,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- f	=>  Location: PIN_25,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \y~0_combout\ = (\s[0]~input_o\) # ((\f~input_o\) # (\s[1]~input_o\))
...
-- Equation(s):
-- \y~1_combout\ = (\s[1]~input_o\) # ((\f~input_o\) # (!\s[0]~input_o\))
...
-- Equation(s):
-- \y~2_combout\ = (\s[0]~input_o\) # ((\f~input_o\) # (!\s[1]~input_o\))
...
-- Equation(s):
-- \y~3_combout\ = ((\f~input_o\) # (!\s[0]~input_o\)) # (!\s[1]~input_o\)
