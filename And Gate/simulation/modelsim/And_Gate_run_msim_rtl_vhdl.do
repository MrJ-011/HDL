...
vcom -93 -work work {H:/HDL/And Gate/And_Gate.vhd}

vcom -93 -work work {H:/HDL/And Gate/And_Gate.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive -L rtl_work -L work -voptargs="+acc"  And Gate
