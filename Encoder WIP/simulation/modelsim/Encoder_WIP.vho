...
ARCHITECTURE structure OF Encoder_WIP IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \b[0]~2_combout\ = (!\a[0]~input_o\ & ((\a[3]~input_o\ & (!\a[2]~input_o\ & !\a[1]~input_o\)) # (!\a[3]~input_o\ & (\a[2]~input_o\ & \a[1]~input_o\))))
...
-- Equation(s):
-- \b[1]~3_combout\ = (\a[3]~input_o\ & (!\a[2]~input_o\ & ((\a[1]~input_o\) # (!\a[0]~input_o\)))) # (!\a[3]~input_o\ & (\a[2]~input_o\ & (!\a[0]~input_o\ & \a[1]~input_o\)))
...
-- Equation(s):
-- \Equal0~0_combout\ = (\a[3]~input_o\ & (!\a[2]~input_o\ & !\a[0]~input_o\))
